System.register(["react","react-dom"], function(__WEBPACK_DYNAMIC_EXPORT__) {
	var __WEBPACK_EXTERNAL_MODULE__0__, __WEBPACK_EXTERNAL_MODULE__1__;
	return {
		setters: [
			function(module) {
				__WEBPACK_EXTERNAL_MODULE__0__ = module;
			},
			function(module) {
				__WEBPACK_EXTERNAL_MODULE__1__ = module;
			}
		],
		execute: function() {
...
var Index = function () {
    return external_react_default.a.createElement("div", { className: "container" }, "This is a react app");
};
var IndexDev = function () {
    return (external_react_default.a.createElement("div", { className: "container-dev" },
        external_react_default.a.createElement(Index, null)));
};
/* harmony default export */ var src_routes = (Index);

// CONCATENATED MODULE: ./src/parcel.tsx




var reactLifecycles = single_spa_react({
    React: external_react_default.a,
    ReactDOM: external_react_dom_default.a,
    rootComponent: src_routes,
});
